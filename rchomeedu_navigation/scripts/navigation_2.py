...
class NavToPoint:
	...
	quaternion2 = quaternion_from_euler(0.0, 0.0, B_theta)
	locations['B'] = Pose(Point(B_x, B_y, 0.000), Quaternion(quaternion2[0], quaternion2[1], quaternion2[2], quaternion2[3]))    
	...
	while not rospy.is_shutdown():
	  ...
	  if start == 1:
		...
		if waiting == 1:
		    ...
		    rospy.sleep(2)
		    rospy.loginfo("Ready to go point B")
		    rospy.sleep(2)
		    global start
		    start = 0
